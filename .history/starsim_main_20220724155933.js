...
additionBoxDescriptionBlock.addEventListener(
  'click',
  (additionClickEvent = () => {
    reinforceWindowRect = reinforceWindow.getBoundingClientRect();
    additionFirstRect = additionBoxDescriptionBlock.getBoundingClientRect();
    additionFirstLeft = additionFirstRect.left;
    additionFirstTop = additionFirstTop.top;
...
let reinforceWindowRect;
let additionFirstRect;
...
additionBoxDescriptionBlock.addEventListener('mousedown', (e) => {
  ...
  const additionRect = additionBoxDescriptionBlock.getBoundingClientRect();
  ...
  console.log(additionFirstTop, additionFirstLeft);
