...
function addAnimationToElem(elem) {
  if (!elem.classList.contains('animated')) {
    elem.classList.add('animated');
  }
}
function removeAnimationToElem(elem) {
  if (elem.classList.contains('animated')) {
...
function animateElem(elem) {
  showElem(elem);
  addAnimationToElem(elem);
}

const animationBorderTwinkleElem = document.querySelector('#borderTwinkle');
const animationCenterTwinkleElem = document.querySelector('#centerTwinkle');

function animateItemReinforce() {
  animateElem(animationBorderTwinkleElem);
  animateElem(animationCenterTwinkleElem);
}
...
reinforceAdditionBoxConfirmBtn.addEventListener('click', () => {
  ...
  setTimeout(() => {
    ...
    hideElem(animationBorderTwinkleElem);
    hideElem(animationCenterTwinkleElem);
