...
function makeClothItemRow(item) {
  ...
  itemRowElem.innerHTML = `
        <div class="itemRow__itemImgBlock" data-type="cloth" data-id=${item.id}>
          ...
          <button class="itemRow__addItemBtn" id="itemRow${itemRowKey}">+</button>
        `;
  return itemRowElem;
}
...
function makeWeaponItemRow(item) {
  ...
  itemRowElem.setAttribute('class', 'itemRow');
  itemRowElem.innerHTML = `
          <div class="itemRow__itemImgBlock" id="${++itemRowKey}" data-type="weapon" data-id=${
    item.id
  }>
              <img src="${item.url}" alt="${item.alt}" class="itemRow__itemImg">
            </div>
            ...
            <button class="itemRow__addItemBtn" id="${itemRowKey}">+</button>
          `;
  return itemRowElem;
}
