...
function updatePreventDestroyCheckBox(userItem, starNum) {
  if (starNum >= 12 && starNum <= 16) {
    if (!preventDestroyCheckBox.classList.contains('ableCheck')) {
      preventDestroyCheckBox.classList.add('ableCheck');
    }
  } else {
    if (preventDestroyCheckBox.classList.contains('ableCheck')) {
      preventDestroyCheckBox.classList.remove('ableCheck');
    }
    preventDestroyCheckBox.checked = false;
  }
}
...
function updateStarforceWindow() {
  ...
  updatePreventDestroyCheckBox(userItem, starNum);
}
