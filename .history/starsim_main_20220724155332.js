...
const additionFirstRect = additionBoxDescriptionBlock.getBoundingClientRect();
const additionFirstLeft = additionFirstRect.left;
const additionFirstTop = additionFirstTop.top;
