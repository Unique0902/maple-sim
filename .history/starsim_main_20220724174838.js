...
reinforceAdditionBoxConfirmBtn.addEventListener(
  'click',
  (dragWindowEvent = () => {
    ...
    console.log(additionFirstLeft, additionFirstTop);
    ...
    console.log(resultFirstLeft, resultFirstTop);
    reinforceAdditionBoxConfirmBtn.removeEventListener(
      'click',
      dragWindowEvent
    );
  })
