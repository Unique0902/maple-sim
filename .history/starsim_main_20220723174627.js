...
function updateDetailStarforce(starNum) {
  if (starNum >= 10) {
    ...
    detailStarforceBox.style.backgroundcolor = 'black';
    detailStarforceDownBox.style.bordertop = '12px solid black';
    ...
    if (starNum <= 14) {
      ...
      detailStarforceBox.style.backgroundcolor = 'red';
      detailStarforceDownBox.style.bordertop = '12px solid red';
