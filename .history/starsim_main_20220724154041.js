...
additionBoxDescriptionBlock.addEventListener('mousedown', (e) => {
  ...
  additionRect = additionBoxDescriptionBlock.getBoundingClientRect();
  reinforceWindowRect = reinforceWindow.getBoundingClientRect();
  additionBoxLeft = additionRect.left + reinforceWindowRect.left;
  additionBoxTop = additionRect.top + reinforceWindowRect.top;
